"""
reference: https://zhouyifan.net/2022/06/01/20220531-styletransfer/
"""
...
style_img = read_image('/cvlabdata2/home/ziyi/6D-Pose/domain-transfer/demo/style.png')
content_img = read_image('/cvlabdata2/home/ziyi/6D-Pose/domain-transfer/demo/content.png')
...
while steps <= 1000 and prev_loss < 100:
    ...
    def closure():
        ...
        if steps % 50 == 0:
            print(f'Step {steps}:')
            print(f'Loss: {loss}')
            save_image(input_img, f'output_{steps}.jpg')
        prev_loss = loss
        return loss
